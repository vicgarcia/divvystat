...
define("morris", ["raphael","jquery"], (function (global) {
    return function () {
        var ret, fn;
...
define("fullscreen", ["mapbox"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.L.map;
    };
}(this)));
...
define("markers", ["mapbox"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.L.AwesomeMarkers;
    };
}(this)));
